...
variable "ecs_telemetry_fluentbit_image" {
  type        = string
  description = "Container image for desired fluent-bit sidecar version. Defaults to `1.0.0`"
  default     = "tryretool/retool-aws-for-fluent-bit:1.0.0"
}
